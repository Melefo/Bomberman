...
namespace RayLib
{
    ...
    void Font::DrawText(const std::string &text, Vector2 position, float fontSize, float spacing, Color tint)
    {
        ::DrawTextEx(font, text.c_str(), {position.x, position.y}, fontSize, spacing, {tint.r, tint.g, tint.b, tint.a});
    }
